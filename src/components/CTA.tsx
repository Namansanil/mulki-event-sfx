      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 text-center">
        ...
        >
          <a 
            ...
            className="group relative inline-flex items-center gap-4 px-12 py-6 bg-white text-black hover:bg-white/90 transition-colors"
          >
            <span className="font-bold tracking-widest text-sm uppercase">LET'S PLAN YOUR EVENT</span>
